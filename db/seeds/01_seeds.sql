...
INSERT INTO maps (user_id, title, description) VALUES (2, 'Best Pool Halls In Calgary', 'I''ve worked long and hard to find the best pool halls in calgary. I can die peacefully knowing i''ve accomplished everything ive set out to do.');
